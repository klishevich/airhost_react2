 ...
 * HousePage Messages
 *
 * This contains all the text for the HousePage component.
 */
import { defineMessages } from 'react-intl';

export default defineMessages({
  header: {
    id: 'boilerplate.containers.HousePage.header',
    defaultMessage: 'Features',
  },
  scaffoldingHeader: {
    id: 'boilerplate.containers.HousePage.scaffolding.header',
    defaultMessage: 'Quick scaffolding',
  },
  scaffoldingMessage: {
    id: 'boilerplate.containers.HousePage.scaffolding.message',
    defaultMessage: `Automate the creation of components, containers, routes, selectors
  and sagas - and their tests - right from the CLI!`,
  },
  feedbackHeader: {
    id: 'boilerplate.containers.HousePage.feedback.header',
    defaultMessage: 'Instant feedback',
  },
  feedbackMessage: {
    id: 'boilerplate.containers.HousePage.feedback.message',
    defaultMessage: `
  ...
  stateManagementHeader: {
    id: 'boilerplate.containers.HousePage.state_management.header',
    defaultMessage: 'Predictable state management',
  },
  stateManagementMessages: {
    id: 'boilerplate.containers.HousePage.state_management.message',
    defaultMessage: `
  ...
  javascriptHeader: {
    id: 'boilerplate.containers.HousePage.javascript.header',
    defaultMessage: 'Next generation JavaScript',
  },
  javascriptMessage: {
    id: 'boilerplate.containers.HousePage.javascript.message',
    defaultMessage: `Use template strings, object destructuring, arrow functions, JSX
    syntax and more, today.`,
  },
  cssHeader: {
    id: 'boilerplate.containers.HousePage.css.header',
    defaultMessage: 'Features',
  },
  cssMessage: {
    id: 'boilerplate.containers.HousePage.css.message',
    defaultMessage: 'Next generation CSS',
  },
  routingHeader: {
    id: 'boilerplate.containers.HousePage.routing.header',
    defaultMessage: 'Industry-standard routing',
  },
  routingMessage: {
    id: 'boilerplate.containers.HousePage.routing.message',
    defaultMessage: `
  ...
  networkHeader: {
    id: 'boilerplate.containers.HousePage.network.header',
    defaultMessage: 'Offline-first',
  },
  networkMessage: {
    id: 'boilerplate.containers.HousePage.network.message',
    defaultMessage: `
  ...
  intlHeader: {
    id: 'boilerplate.containers.HousePage.internationalization.header',
    defaultMessage: 'Complete i18n Standard Internationalization & Pluralization',
  },
  intlMessage: {
    id: 'boilerplate.containers.HousePage.internationalization.message',
  ...
  homeButton: {
    id: 'boilerplate.containers.HousePage.home',
    defaultMessage: 'Home',
  },
});
